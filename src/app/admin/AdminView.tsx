...
import SpicyRatingsAdmin from './SpicyRatingsAdmin'
...
type Tab = 'ramen' | 'julGimbap' | 'dosirak' | 'hotbar' | 'snacks' | 'log' | 'best5' | 'toppings' | 'countryPicks' | 'recipes' | 'feedback' | 'spicyRatings' | { catId: number }
...
export default function AdminView({ categories }: { categories: Category[] }) {
  ...
  const MENU = [
    ...
    { tab: 'spicyRatings' as Tab, label: '맵기 평가',  icon: '🌶️' },
  ]
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 max-w-4xl w-full mx-auto space-y-4">
          ...
          {activeTab === 'spicyRatings' && <SpicyRatingsAdmin />}
